...
<head>
	...
	<title><?php echo app_config('web-site-name'); ?> | Konfirmasi Email</title>
</head>
<body
                            ...
                            <table
                                ...
                                <tr
                                    ...
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        <p>
											Silahkan konfirmasi akun anda dengan mengklik tautan dibawah ini. Kami mungkin perlu mengirimkan anda informasi penting tentang layanan kami dan penting bahwa kami memiliki alamat email yang akurat. 
										</p>
                                    </td>
                                </tr>
                                <tr
                                    ...
                                    <td class="content-block" itemprop="handler"
                                        ...
                                        style="margin: 0pt; padding: 0pt 0pt 20px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; vertical-align: top;"
                                        valign="top"><a
                                            href="<?php echo base_url('auth/activate/'.$id."/".base64_encode($activation));?>"
                                            ...
                                            <?php echo lang('email_activate_link'); ?>
                                        </a> <br>
                                    </td>
                                </tr>
                                <tr
