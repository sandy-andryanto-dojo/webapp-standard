...
$config['tables']['users_groups']    = 'auth_user_roles';
...
$config['admin_email']                = "super.admin@devel.com"; // Admin Email, admin@example.com
...
$config['email_activation']           = (ENVIRONMENT !== 'production' ? FALSE : TRUE);               // Email Activation for registration
$config['manual_activation']          = (ENVIRONMENT !== 'production' ? TRUE : FALSE);               // Manual Activation for registration
